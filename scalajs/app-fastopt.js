...
/** @constructor */
function $c_Lcom_rockthejvm_Perlin$() {
  this.Lcom_rockthejvm_Perlin$__f_permutation = null;
  $n_Lcom_rockthejvm_Perlin$ = this;
  this.Lcom_rockthejvm_Perlin$__f_permutation = this.makePermutation__I__AI(256)
}
$c_Lcom_rockthejvm_Perlin$.prototype = new $h_O();
$c_Lcom_rockthejvm_Perlin$.prototype.constructor = $c_Lcom_rockthejvm_Perlin$;
/** @constructor */
function $h_Lcom_rockthejvm_Perlin$() {
  /*<skip>*/
}
$h_Lcom_rockthejvm_Perlin$.prototype = $c_Lcom_rockthejvm_Perlin$.prototype;
$c_Lcom_rockthejvm_Perlin$.prototype.shuffle__AI__V = (function(arrayToShuffle) {
  var end = $n(arrayToShuffle).u.length;
  var isEmpty = (end <= 1);
  ...
  if ((!isEmpty)) {
    ...
    while (true) {
      var arg1 = i;
      var a = ($uD(Math.random()) * (((-1) + arg1) | 0));
      var this$13 = $m_RTLong$();
      var value$1 = $uD(Math.round(a));
      var lo$3 = this$13.org$scalajs$linker$runtime$RuntimeLong$$fromDoubleImpl__D__I(value$1);
      var temp = $n(arrayToShuffle).get(arg1);
      $n(arrayToShuffle).set(arg1, $n(arrayToShuffle).get(lo$3));
      $n(arrayToShuffle).set(lo$3, temp);
...
$c_Lcom_rockthejvm_Perlin$.prototype.makePermutation__I__AI = (function(range) {
  var isEmpty = (range <= 0);
  if (isEmpty) {
    var scala$collection$immutable$Range$$numRangeElements = 0
  } else {
    var hi = (range >> 31);
    var scala$collection$immutable$Range$$numRangeElements = (((hi === 0) ? (((-2147483648) ^ range) > (-1)) : (hi > 0)) ? (-1) : range)
  };
  var scala$collection$immutable$Range$$lastElement = (((-1) + range) | 0);
  $m_s_reflect_ManifestFactory$IntManifest$();
  if ((scala$collection$immutable$Range$$numRangeElements < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__E(0, range, 1, false)
  };
  if ((scala$collection$immutable$Range$$numRangeElements >= 0)) {
    if ((scala$collection$immutable$Range$$numRangeElements < 0)) {
      $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__E(0, range, 1, false)
    };
    var destination = new $ac_I(scala$collection$immutable$Range$$numRangeElements);
    var it = new $c_sci_RangeIterator(0, 1, scala$collection$immutable$Range$$lastElement, isEmpty);
    var i = 0;
    var y = destination.u.length;
    while (((i < y) && it.sci_RangeIterator__f__hasNext)) {
    ...
    capacity = 0;
    jsElems = [];
    var it$1 = new $c_sci_RangeIterator(0, 1, scala$collection$immutable$Range$$lastElement, isEmpty);
    while (it$1.sci_RangeIterator__f__hasNext) {
      var elem = it$1.next__I();
      jsElems.push(elem)
    };
    var array = new $ac_I(new Int32Array(jsElems))
  };
  this.shuffle__AI__V(array);
  $m_sc_ArrayOps$();
  $m_s_reflect_ManifestFactory$IntManifest$();
  $m_sc_ArrayOps$();
  var this$19 = $m_s_Array$();
  var newLength = (($n(array).u.length + $n(array).u.length) | 0);
  var this$20 = $n(array);
  if ($d_I.getClassOf().isAssignableFrom__jl_Class__Z($objectGetClass(this$20).getComponentType__jl_Class())) {
    if ($d_I.getClassOf().isPrimitive__Z()) {
      var dest$1 = this$19.copyOf__O__I__O(array, newLength)
    } else {
      var original = $asArrayOf_O(array, 1);
    ...
    $m_s_Array$().copy__O__I__O__I__I__V(array, 0, dest, 0, $n(array).u.length);
    var dest$1 = dest
  };
  $m_s_Array$().copy__O__I__O__I__I__V(array, 0, dest$1, $n(array).u.length, $n(array).u.length);
  return $asArrayOf_I(dest$1, 1)
});
$c_Lcom_rockthejvm_Perlin$.prototype.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3 = (function(v) {
  var x10 = (7 & v);
  switch (x10) {
    case 0: {
      return new $c_Lcom_rockthejvm_Perlin$Vector3(1.0, 1.0, 1.0);
      break
    }
    case 1: {
      return new $c_Lcom_rockthejvm_Perlin$Vector3((-1.0), 1.0, 1.0);
...
$c_Lcom_rockthejvm_Perlin$.prototype.fade__D__D = (function(t) {
  return (((((((6.0 * t) - 15.0) * t) + 10.0) * t) * t) * t)
});
$c_Lcom_rockthejvm_Perlin$.prototype.lerp__D__D__D__D = (function(t, a1, a2) {
  return (a1 + (t * (a2 - a1)))
});
$c_Lcom_rockthejvm_Perlin$.prototype.noise3D__D__D__D__D = (function(x, y, z) {
  var cellX = (255 & $doubleToInt($uD(Math.floor(x))));
  var cellY = (255 & $doubleToInt($uD(Math.floor(y))));
  var cellZ = (255 & $doubleToInt($uD(Math.floor(z))));
  var xf = (x - $uD(Math.floor(x)));
  var yf = (y - $uD(Math.floor(y)));
  var zf = (z - $uD(Math.floor(z)));
  var x$1 = (xf - 1.0);
  var y$1 = (yf - 1.0);
  var z$1 = (zf - 1.0);
  var topRightNear = new $c_Lcom_rockthejvm_Perlin$Vector3(x$1, y$1, z$1);
  var y$2 = (yf - 1.0);
  var z$2 = (zf - 1.0);
  var topLeftNear = new $c_Lcom_rockthejvm_Perlin$Vector3(xf, y$2, z$2);
  var x$2 = (xf - 1.0);
  var z$3 = (zf - 1.0);
  var bottomRightNear = new $c_Lcom_rockthejvm_Perlin$Vector3(x$2, yf, z$3);
  var z$4 = (zf - 1.0);
  var bottomLeftNear = new $c_Lcom_rockthejvm_Perlin$Vector3(xf, yf, z$4);
  var x$3 = (xf - 1.0);
  var y$3 = (yf - 1.0);
  new $c_Lcom_rockthejvm_Perlin$Vector3(x$3, y$3, zf);
  var y$4 = (yf - 1.0);
  new $c_Lcom_rockthejvm_Perlin$Vector3(xf, y$4, zf);
  var x$4 = (xf - 1.0);
  new $c_Lcom_rockthejvm_Perlin$Vector3(x$4, yf, zf);
  new $c_Lcom_rockthejvm_Perlin$Vector3(xf, yf, zf);
  var valueTopRightNear = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + cellX) | 0)) + cellY) | 0)) | 0)) + cellZ) | 0)) | 0));
  var valueTopLeftNear = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(cellX) + cellY) | 0)) | 0)) + cellZ) | 0)) | 0));
  var valueBottomRightNear = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + cellX) | 0)) + cellY) | 0)) + cellZ) | 0)) | 0));
  var valueBottomLeftNear = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(cellX) + cellY) | 0)) + cellZ) | 0)) | 0));
  var valueTopRightFar = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + cellX) | 0)) + cellY) | 0)) | 0)) + cellZ) | 0));
  var valueTopLeftFar = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + (($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(cellX) + cellY) | 0)) | 0)) + cellZ) | 0));
  var valueBottomRightFar = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(((1 + cellX) | 0)) + cellY) | 0)) + cellZ) | 0));
  var valueBottomLeftFar = $n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get((($n(this.Lcom_rockthejvm_Perlin$__f_permutation).get(cellX) + cellY) | 0)) + cellZ) | 0));
  var dotTopRightNear = topRightNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueTopRightNear));
  var dotTopLeftNear = topLeftNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueTopLeftNear));
  var dotBottomRightNear = bottomRightNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueBottomRightNear));
  var dotBottomLeftNear = bottomLeftNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueBottomLeftNear));
  var dotTopRightFar = topRightNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueTopRightFar));
  var dotTopLeftFar = topLeftNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueTopLeftFar));
  var dotBottomRightFar = bottomRightNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueBottomRightFar));
  var dotBottomLeftFar = bottomLeftNear.$times__Lcom_rockthejvm_Perlin$Vector3__D(this.getConstantVector3D__I__Lcom_rockthejvm_Perlin$Vector3(valueBottomLeftFar));
  var u = this.fade__D__D(xf);
  var v = this.fade__D__D(yf);
  var w = this.fade__D__D(zf);
  return this.lerp__D__D__D__D(u, this.lerp__D__D__D__D(v, this.lerp__D__D__D__D(w, dotBottomLeftNear, dotBottomLeftFar), this.lerp__D__D__D__D(w, dotTopLeftNear, dotTopLeftFar)), this.lerp__D__D__D__D(v, this.lerp__D__D__D__D(w, dotBottomRightNear, dotBottomRightFar), this.lerp__D__D__D__D(w, dotTopRightNear, dotTopRightFar)))
});
var $d_Lcom_rockthejvm_Perlin$ = new $TypeData().initClass({
  Lcom_rockthejvm_Perlin$: 0
}, false, "com.rockthejvm.Perlin$", {
  Lcom_rockthejvm_Perlin$: 1,
  O: 1
});
$c_Lcom_rockthejvm_Perlin$.prototype.$classData = $d_Lcom_rockthejvm_Perlin$;
var $n_Lcom_rockthejvm_Perlin$;
function $m_Lcom_rockthejvm_Perlin$() {
  if ((!$n_Lcom_rockthejvm_Perlin$)) {
    $n_Lcom_rockthejvm_Perlin$ = new $c_Lcom_rockthejvm_Perlin$()
  };
  return $n_Lcom_rockthejvm_Perlin$
}
function $s_Lcom_rockthejvm_Scalar2024__main__AT__V(args) {
  $m_Lcom_rockthejvm_Scalar2024$().main__AT__V(args)
}
/** @constructor */
function $c_Lcom_rockthejvm_Scalar2024$() {
  this.Lcom_rockthejvm_Scalar2024$__f_displayCanvas = null;
  this.Lcom_rockthejvm_Scalar2024$__f_context = null;
  this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas = null;
  this.Lcom_rockthejvm_Scalar2024$__f_offScreenContext = null;
  this.Lcom_rockthejvm_Scalar2024$__f_video = null;
  this.Lcom_rockthejvm_Scalar2024$__f_displayWidth = 0;
  this.Lcom_rockthejvm_Scalar2024$__f_displayHeight = 0;
  this.Lcom_rockthejvm_Scalar2024$__f_gridSize = 0;
  this.Lcom_rockthejvm_Scalar2024$__f_grid = null;
  this.Lcom_rockthejvm_Scalar2024$__f_resolution = 0;
  this.Lcom_rockthejvm_Scalar2024$__f_nParticles = 0;
  this.Lcom_rockthejvm_Scalar2024$__f_maxAge = 0;
  this.Lcom_rockthejvm_Scalar2024$__f_stepLength = 0;
  $n_Lcom_rockthejvm_Scalar2024$ = this;
  this.Lcom_rockthejvm_Scalar2024$__f_displayCanvas = document.getElementById("displayCanvas");
  this.Lcom_rockthejvm_Scalar2024$__f_context = this.Lcom_rockthejvm_Scalar2024$__f_displayCanvas.getContext("2d");
  this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas = document.getElementById("offCanvas");
  this.Lcom_rockthejvm_Scalar2024$__f_offScreenContext = this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.getContext("2d");
  this.Lcom_rockthejvm_Scalar2024$__f_video = document.getElementById("video");
  this.Lcom_rockthejvm_Scalar2024$__f_displayWidth = $uI(this.Lcom_rockthejvm_Scalar2024$__f_displayCanvas.width);
  this.Lcom_rockthejvm_Scalar2024$__f_displayHeight = $uI(this.Lcom_rockthejvm_Scalar2024$__f_displayCanvas.height);
  this.Lcom_rockthejvm_Scalar2024$__f_gridSize = 100;
  var dimensions = new $ac_I(new Int32Array([this.Lcom_rockthejvm_Scalar2024$__f_gridSize, this.Lcom_rockthejvm_Scalar2024$__f_gridSize]));
  this.Lcom_rockthejvm_Scalar2024$__f_grid = $asArrayOf_D($m_jl_reflect_Array$().newInstance__jl_Class__AI__O($d_D.getClassOf(), dimensions), 2);
  this.Lcom_rockthejvm_Scalar2024$__f_resolution = $intDiv(this.Lcom_rockthejvm_Scalar2024$__f_displayWidth, this.Lcom_rockthejvm_Scalar2024$__f_gridSize);
  this.Lcom_rockthejvm_Scalar2024$__f_nParticles = 2000;
  this.Lcom_rockthejvm_Scalar2024$__f_maxAge = 30;
  this.Lcom_rockthejvm_Scalar2024$__f_stepLength = 5
}
$c_Lcom_rockthejvm_Scalar2024$.prototype = new $h_O();
$c_Lcom_rockthejvm_Scalar2024$.prototype.constructor = $c_Lcom_rockthejvm_Scalar2024$;
/** @constructor */
function $h_Lcom_rockthejvm_Scalar2024$() {
  /*<skip>*/
}
$h_Lcom_rockthejvm_Scalar2024$.prototype = $c_Lcom_rockthejvm_Scalar2024$.prototype;
$c_Lcom_rockthejvm_Scalar2024$.prototype.startVideo__V = (function() {
  var \u03b41$ = window.navigator.mediaDevices.getUserMedia((() => {
    var this$1 = {};
    this$1.video = (() => {
      var this$2 = {};
      this$2.width = 100.0;
  ...
  \u03b41$.then(((stream) => {
    this.Lcom_rockthejvm_Scalar2024$__f_video.srcObject = stream;
    return this.Lcom_rockthejvm_Scalar2024$__f_video.play()
  }))
});
$c_Lcom_rockthejvm_Scalar2024$.prototype.makeRandomField__V = (function() {
  var $x_1 = this.Lcom_rockthejvm_Scalar2024$__f_offScreenContext;
  var x = $uI(this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.width);
  var x$1 = $uI(this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.height);
  $x_1.clearRect(0.0, 0.0, x, x$1);
  var $x_3 = this.Lcom_rockthejvm_Scalar2024$__f_offScreenContext;
  var $x_2 = this.Lcom_rockthejvm_Scalar2024$__f_video;
  var x$2 = $uI(this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.width);
  var x$3 = $uI(this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.height);
  $x_3.drawImage($x_2, 0.0, 0.0, x$2, x$3);
  var $x_4 = this.Lcom_rockthejvm_Scalar2024$__f_offScreenContext;
  var x$4 = $uI(this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.width);
  var x$5 = $uI(this.Lcom_rockthejvm_Scalar2024$__f_offScreenCanvas.height);
  var imageData = $x_4.getImageData(0.0, 0.0, x$4, x$5);
  var brightnessMatrix = $m_Lcom_rockthejvm_Tools$().calculateBrightness__Lorg_scalajs_dom_ImageData__AAD(imageData);
  var end = this.Lcom_rockthejvm_Scalar2024$__f_gridSize;
  var isEmpty = (end <= 0);
  var scala$collection$immutable$Range$$lastElement = (((-1) + end) | 0);
  if ((!isEmpty)) {
    var i = 0;
    while (true) {
      var arg1 = i;
      var end$1 = this.Lcom_rockthejvm_Scalar2024$__f_gridSize;
      ...
      if ((!isEmpty$1)) {
        ...
        while (true) {
          var arg1$1 = i$1;
          var scaledBrightness = (0.002 * $n($n(brightnessMatrix).get(arg1)).get(arg1$1));
          $n($n(this.Lcom_rockthejvm_Scalar2024$__f_grid).get(arg1)).set(arg1$1, (3.141592653589793 * (2.0 * $m_Lcom_rockthejvm_Perlin$().noise3D__D__D__D__D((0.002 * arg1), (0.002 * arg1$1), scaledBrightness))));
...
$c_Lcom_rockthejvm_Scalar2024$.prototype.drawParticles__sci_List__V = (function(particleTrails) {
  this.makeRandomField__V();
  this.Lcom_rockthejvm_Scalar2024$__f_context.fillStyle = "black";
  var $x_1 = this.Lcom_rockthejvm_Scalar2024$__f_context;
  var x = this.Lcom_rockthejvm_Scalar2024$__f_displayWidth;
  var x$1 = this.Lcom_rockthejvm_Scalar2024$__f_displayHeight;
  $x_1.fillRect(0.0, 0.0, x, x$1);
  var this$13 = $n($as_sci_List($n(particleTrails).head__O()));
  var f = ((x$1$1) => {
    var x$1$2 = $as_T3(x$1$1);
    if ((x$1$2 !== null)) {
      var x$2 = $uD($n(x$1$2).T3__f__1);
      var y = $uD($n(x$1$2).T3__f__2);
      var age = $uI($n(x$1$2).T3__f__3);
      var row = $doubleToInt((y / this.Lcom_rockthejvm_Scalar2024$__f_resolution));
      var col = $doubleToInt((x$2 / this.Lcom_rockthejvm_Scalar2024$__f_resolution));
      if ((((((row >= 0) && (row < this.Lcom_rockthejvm_Scalar2024$__f_gridSize)) && (col >= 0)) && (col < this.Lcom_rockthejvm_Scalar2024$__f_gridSize)) && (age < this.Lcom_rockthejvm_Scalar2024$__f_maxAge))) {
        var angle = $n($n(this.Lcom_rockthejvm_Scalar2024$__f_grid).get(row)).get(col);
        var _1 = (x$2 + (this.Lcom_rockthejvm_Scalar2024$__f_stepLength * $uD(Math.cos(angle))));
        var _2 = (y + (this.Lcom_rockthejvm_Scalar2024$__f_stepLength * $uD(Math.sin(angle))));
        var _3 = ((1 + age) | 0);
        return new $c_T3(_1, _2, _3)
      } else {
        var _1$1 = ($uD(Math.random()) * this.Lcom_rockthejvm_Scalar2024$__f_displayWidth);
        var _2$1 = ($uD(Math.random()) * this.Lcom_rockthejvm_Scalar2024$__f_displayHeight);
        return new $c_T3(_1$1, _2$1, 0)
      }
    };
    throw new $c_s_MatchError(x$1$2)
  });
  if ((this$13 === $m_sci_Nil$())) {
    var newParticles = $m_sci_Nil$()
  } else {
  ...
  if (($n(particleTrails).length__I() > this.Lcom_rockthejvm_Scalar2024$__f_maxAge)) {
    var this$14 = $n($as_sci_List($n(particleTrails).init__O()));
    var newParticleTrails = new $c_sci_$colon$colon(newParticles, this$14)
  } else {
    var this$15 = $n(particleTrails);
    var newParticleTrails = new $c_sci_$colon$colon(newParticles, this$15)
  };
  var this$16 = $n(newParticleTrails);
  var $x_2 = $as_sc_StrictOptimizedIterableOps($f_sc_IterableOps__init__O(this$16));
  var this$17 = $n(newParticleTrails);
  var this$18 = $n($as_sc_StrictOptimizedIterableOps($n($x_2).zip__sc_IterableOnce__O(this$17.sci_$colon$colon__f_next)));
  var this$19 = $n($as_sci_List($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(this$18)));
  var these = this$19;
  while ((!$n(these).isEmpty__Z())) {
    var arg1$2 = $n(these).head__O();
    var x$1$3 = $as_T2(arg1$2);
    matchResult4: {
      if ((x$1$3 !== null)) {
        var x24 = $as_T2($n(x$1$3).T2__f__1);
        if ((x24 !== null)) {
          var newPositions = $as_sci_List($n(x24).T2__f__1);
          var oldPositions = $as_sci_List($n(x24).T2__f__2);
          var age$1 = $uI($n(x$1$3).T2__f__2);
          var this$20 = $n(newPositions);
          var this$24 = $n($as_sci_List($f_sc_StrictOptimizedIterableOps__zip__sc_IterableOnce__O(this$20, oldPositions)));
          var f$1 = ((x$1$2$1) => {
            var x$1$4 = $as_T2(x$1$2$1);
            if ((x$1$4 !== null)) {
              var x6 = $as_T3($n(x$1$4).T2__f__1);
              var x7 = $as_T3($n(x$1$4).T2__f__2);
              if ((x6 !== null)) {
                var newX = $uD($n(x6).T3__f__1);
                var newY = $uD($n(x6).T3__f__2);
                if ((x7 !== null)) {
                  var x$3 = $uD($n(x7).T3__f__1);
                  var y$1 = $uD($n(x7).T3__f__2);
                  var a = (newX - x$3);
                  if (($uD(Math.abs(a)) <= this.Lcom_rockthejvm_Scalar2024$__f_stepLength)) {
                    var a$1 = (newY - y$1);
                    return ($uD(Math.abs(a$1)) <= this.Lcom_rockthejvm_Scalar2024$__f_stepLength)
                  } else {
                    return false
                  }
                }
          ...
          var this$25 = $n(result);
          var these$1 = this$25;
          while ((!$n(these$1).isEmpty__Z())) {
            var arg1$3 = $n(these$1).head__O();
            var x$1$5 = $as_T2(arg1$3);
            matchResult3: {
              if ((x$1$5 !== null)) {
                var x15 = $as_T3($n(x$1$5).T2__f__1);
                var x16 = $as_T3($n(x$1$5).T2__f__2);
                if ((x15 !== null)) {
                  var newX$1 = $uD($n(x15).T3__f__1);
                  var newY$1 = $uD($n(x15).T3__f__2);
                  $uI($n(x15).T3__f__3);
                  if ((x16 !== null)) {
                    var x$5 = $uD($n(x16).T3__f__1);
                    var y$2 = $uD($n(x16).T3__f__2);
                    this.Lcom_rockthejvm_Scalar2024$__f_context.beginPath();
                    var $x_3 = this.Lcom_rockthejvm_Scalar2024$__f_context;
                    var s = $m_Lcom_rockthejvm_Tools$().lerpColorFade__D__I__I__T((age$1 / this.Lcom_rockthejvm_Scalar2024$__f_maxAge), 33023, 8388863);
                    $x_3.strokeStyle = s;
                    this.Lcom_rockthejvm_Scalar2024$__f_context.lineWidth = 1.0;
                    this.Lcom_rockthejvm_Scalar2024$__f_context.moveTo(x$5, y$2);
                    this.Lcom_rockthejvm_Scalar2024$__f_context.lineTo(newX$1, newY$1);
                    this.Lcom_rockthejvm_Scalar2024$__f_context.stroke();
                    break matchResult3
                  }
                }
              };
  ...
  window.requestAnimationFrame(((_$1) => {
    $uD(_$1);
    this.drawParticles__sci_List__V(newParticleTrails)
  }))
});
$c_Lcom_rockthejvm_Scalar2024$.prototype.makeGoodArt__V = (function() {
  var end = this.Lcom_rockthejvm_Scalar2024$__f_nParticles;
  var isEmpty = (end < 1);
  if (isEmpty) {
    var scala$collection$immutable$Range$$numRangeElements = 0
  } else {
  ...
  var it = new $c_sci_RangeIterator(1, 1, end, isEmpty);
  while (it.sci_RangeIterator__f__hasNext) {
    var this$11 = $n(b);
    it.next__I();
    var x = ($uD(Math.random()) * this.Lcom_rockthejvm_Scalar2024$__f_displayWidth);
    var y = ($uD(Math.random()) * this.Lcom_rockthejvm_Scalar2024$__f_displayHeight);
    var age = $doubleToInt(($uD(Math.random()) * this.Lcom_rockthejvm_Scalar2024$__f_maxAge));
    var elem = new $c_T3(x, y, age);
    this$11.addOne__O__scm_Growable(elem)
  };
  var particles = $as_sci_IndexedSeq($n(b).result__O());
  $n($m_s_package$().s_package$__f_List);
  var $x_1 = $m_sr_ScalaRunTime$();
  var this$12 = $n(particles);
  $m_sci_List$();
  var elems = $n($x_1).wrapRefArray__AO__sci_ArraySeq(new ($d_sci_List.getArrayOf().constr)([$m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(this$12)]));
  this.drawParticles__sci_List__V($m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems))
});
$c_Lcom_rockthejvm_Scalar2024$.prototype.main__AT__V = (function(args) {
  this.startVideo__V();
  this.makeGoodArt__V()
});
var $d_Lcom_rockthejvm_Scalar2024$ = new $TypeData().initClass({
  Lcom_rockthejvm_Scalar2024$: 0
}, false, "com.rockthejvm.Scalar2024$", {
  Lcom_rockthejvm_Scalar2024$: 1,
  O: 1
});
$c_Lcom_rockthejvm_Scalar2024$.prototype.$classData = $d_Lcom_rockthejvm_Scalar2024$;
var $n_Lcom_rockthejvm_Scalar2024$;
function $m_Lcom_rockthejvm_Scalar2024$() {
  if ((!$n_Lcom_rockthejvm_Scalar2024$)) {
    $n_Lcom_rockthejvm_Scalar2024$ = new $c_Lcom_rockthejvm_Scalar2024$()
  };
  return $n_Lcom_rockthejvm_Scalar2024$
}
/** @constructor */
function $c_Lcom_rockthejvm_Tools$() {
  /*<skip>*/
}
$c_Lcom_rockthejvm_Tools$.prototype = new $h_O();
$c_Lcom_rockthejvm_Tools$.prototype.constructor = $c_Lcom_rockthejvm_Tools$;
/** @constructor */
function $h_Lcom_rockthejvm_Tools$() {
  /*<skip>*/
}
$h_Lcom_rockthejvm_Tools$.prototype = $c_Lcom_rockthejvm_Tools$.prototype;
$c_Lcom_rockthejvm_Tools$.prototype.calculateBrightness__Lorg_scalajs_dom_ImageData__AAD = (function(imageData) {
  var dimensions = new $ac_I(new Int32Array([$uI(imageData.height), $uI(imageData.width)]));
  var brightnessMatrix = $asArrayOf_D($m_jl_reflect_Array$().newInstance__jl_Class__AI__O($d_D.getClassOf(), dimensions), 2);
  var end = $uI(imageData.height);
  var isEmpty = (end <= 0);
  var scala$collection$immutable$Range$$lastElement = (((-1) + end) | 0);
  if ((!isEmpty)) {
    var i = 0;
    while (true) {
      ...
      if ((!isEmpty$1)) {
        ...
        while (true) {
          var arg1$1 = i$1;
          var index = (((Math.imul(arg1, $uI(imageData.width)) + arg1$1) | 0) << 2);
          var r = $uI(imageData.data[index]);
          var g = $uI(imageData.data[((1 + index) | 0)]);
          var b = $uI(imageData.data[((2 + index) | 0)]);
          var brightness = (((0.299 * r) + (0.587 * g)) + (0.114 * b));
          $n($n(brightnessMatrix).get(arg1)).set(arg1$1, brightness);
          if ((i$1 === scala$collection$immutable$Range$$lastElement$1)) {
            break
          };
          i$1 = ((1 + i$1) | 0)
...
$c_Lcom_rockthejvm_Tools$.prototype.lerpColorFade__D__I__I__T = (function(v, a, b) {
  var redA = ((16711680 & a) >> 16);
  var greenA = ((65280 & a) >> 8);
  var blueA = (255 & a);
  var redB = ((16711680 & b) >> 16);
  var greenB = ((65280 & b) >> 8);
  var blueB = (255 & b);
  var t = ((v < 0.0) ? 0.0 : ((v > 1.0) ? 1.0 : v));
  var red = $doubleToInt(((t * redA) + ((1.0 - t) * redB)));
  var green = $doubleToInt(((t * greenA) + ((1.0 - t) * greenB)));
  var blue = $doubleToInt(((t * blueA) + ((1.0 - t) * blueB)));
  var alpha = (1.0 - t);
  return (((((((("rgba(" + red) + ",") + green) + ",") + blue) + ",") + alpha) + ")")
});
var $d_Lcom_rockthejvm_Tools$ = new $TypeData().initClass({
  Lcom_rockthejvm_Tools$: 0
}, false, "com.rockthejvm.Tools$", {
  Lcom_rockthejvm_Tools$: 1,
  O: 1
});
$c_Lcom_rockthejvm_Tools$.prototype.$classData = $d_Lcom_rockthejvm_Tools$;
var $n_Lcom_rockthejvm_Tools$;
function $m_Lcom_rockthejvm_Tools$() {
  if ((!$n_Lcom_rockthejvm_Tools$)) {
    $n_Lcom_rockthejvm_Tools$ = new $c_Lcom_rockthejvm_Tools$()
  };
  return $n_Lcom_rockthejvm_Tools$
}
/** @constructor */
...
$c_sc_ArrayOps$.prototype.slice$extension__O__I__I__O = (function(this$, from, until) {
  ...
  if ((hi > lo)) {
    ...
    var this$5 = $n(this$);
    return $n($n($x_1).apply__jl_Class__s_reflect_ClassTag($n($objectGetClass(this$5)).getComponentType__jl_Class())).newArray__I__O(0)
  }
});
...
/** @constructor */
function $c_Lcom_rockthejvm_Perlin$Vector3(x, y, z) {
  this.Lcom_rockthejvm_Perlin$Vector3__f_x = 0.0;
  this.Lcom_rockthejvm_Perlin$Vector3__f_y = 0.0;
  this.Lcom_rockthejvm_Perlin$Vector3__f_z = 0.0;
  this.Lcom_rockthejvm_Perlin$Vector3__f_x = x;
  this.Lcom_rockthejvm_Perlin$Vector3__f_y = y;
  this.Lcom_rockthejvm_Perlin$Vector3__f_z = z
}
$c_Lcom_rockthejvm_Perlin$Vector3.prototype = new $h_O();
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.constructor = $c_Lcom_rockthejvm_Perlin$Vector3;
/** @constructor */
function $h_Lcom_rockthejvm_Perlin$Vector3() {
  /*<skip>*/
}
$h_Lcom_rockthejvm_Perlin$Vector3.prototype = $c_Lcom_rockthejvm_Perlin$Vector3.prototype;
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this)
});
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Vector3");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var dv = this.Lcom_rockthejvm_Perlin$Vector3__f_x;
  var data$1 = $m_sr_Statics$().doubleHash__D__I(dv);
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  var dv$1 = this.Lcom_rockthejvm_Perlin$Vector3__f_y;
  var data$2 = $m_sr_Statics$().doubleHash__D__I(dv$1);
  acc = $m_sr_Statics$().mix__I__I__I(hash$2, data$2);
  var hash$3 = acc;
  var dv$2 = this.Lcom_rockthejvm_Perlin$Vector3__f_z;
...
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.productArity__I = (function() {
  return 3
});
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.productPrefix__T = (function() {
  return "Vector3"
});
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.productElement__I__O = (function(n) {
  switch (n) {
    case 0: {
      return this.Lcom_rockthejvm_Perlin$Vector3__f_x;
      break
    }
    case 1: {
      return this.Lcom_rockthejvm_Perlin$Vector3__f_y;
      break
    }
    case 2: {
      return this.Lcom_rockthejvm_Perlin$Vector3__f_z;
      break
    }
    default: {
      throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
...
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.$times__Lcom_rockthejvm_Perlin$Vector3__D = (function(other) {
  return (((this.Lcom_rockthejvm_Perlin$Vector3__f_x * $n(other).Lcom_rockthejvm_Perlin$Vector3__f_x) + (this.Lcom_rockthejvm_Perlin$Vector3__f_y * $n(other).Lcom_rockthejvm_Perlin$Vector3__f_y)) + (this.Lcom_rockthejvm_Perlin$Vector3__f_z * $n(other).Lcom_rockthejvm_Perlin$Vector3__f_z))
});
var $d_Lcom_rockthejvm_Perlin$Vector3 = new $TypeData().initClass({
  Lcom_rockthejvm_Perlin$Vector3: 0
}, false, "com.rockthejvm.Perlin$Vector3", {
  Lcom_rockthejvm_Perlin$Vector3: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
  Ljava_io_Serializable: 1
});
$c_Lcom_rockthejvm_Perlin$Vector3.prototype.$classData = $d_Lcom_rockthejvm_Perlin$Vector3;
...
function $f_sc_StrictOptimizedIterableOps__dropRight__I__O($thiz, n) {
  ...
  if ((n >= 0)) {
    var this$1 = $n(b);
    var delta = ((-n) | 0);
    $f_scm_Builder__sizeHint__sc_IterableOnce__I__V(this$1, $thiz, delta)
  };
...
var $d_sc_View$DropRightIterator = new $TypeData().initClass({
  sc_View$DropRightIterator: 0
}, false, "scala.collection.View$DropRightIterator", {
...
function $c_scm_ArraySeq$() {
  ...
  new $c_scm_ArraySeq$ofRef(new $ac_O(0))
}
...
var $d_sc_View$DropRight = new $TypeData().initClass({
  sc_View$DropRight: 0
}, false, "scala.collection.View$DropRight", {
  sc_View$DropRight: 1,
  sc_AbstractView: 1,
  sc_AbstractIterable: 1,
  O: 1,
...
var $d_sc_SeqView$DropRight = new $TypeData().initClass({
  sc_SeqView$DropRight: 0
}, false, "scala.collection.SeqView$DropRight", {
...
$c_sc_SeqView$DropRight.prototype.$classData = $d_sc_SeqView$DropRight;
...
$c_sc_IndexedSeqView$DropRight.prototype.$classData = $d_sc_IndexedSeqView$DropRight;
/** @constructor */
...
var $d_scm_CheckedIndexedSeqView$DropRight = new $TypeData().initClass({
  scm_CheckedIndexedSeqView$DropRight: 0
}, false, "scala.collection.mutable.CheckedIndexedSeqView$DropRight", {
...
$c_scm_CheckedIndexedSeqView$DropRight.prototype.$classData = $d_scm_CheckedIndexedSeqView$DropRight;
...
function $p_sci_LazyList__dropRightState__sci_LazyList__sci_LazyList$State($thiz, scout) {
  if ($n(scout).isEmpty__Z()) {
    ...
    var state = new $c_sjsr_AnonFunction0((() => {
      ...
      var this$2 = $n(scout);
      return $p_sci_LazyList__dropRightState__sci_LazyList__sci_LazyList$State($n($x_1), $n(this$2.scala$collection$immutable$LazyList$$state__sci_LazyList$State()).tail__sci_LazyList())
    }));
    var tl = new $c_sci_LazyList(state);
    return new $c_sci_LazyList$State$Cons(hd, tl)
  }
...
$c_sci_ArraySeq.prototype.zip__sc_IterableOnce__sci_ArraySeq = (function(that) {
  if ((that instanceof $c_sci_ArraySeq)) {
    ...
    while ((i < n)) {
      var $x_1 = i;
      var arg1 = i;
      elements.set($x_1, new $c_T2(this.apply__I__O(arg1), $n(x2).apply__I__O(arg1)));
      i = ((1 + i) | 0)
    };
...
$h_scm_ArraySeq.prototype = $c_scm_ArraySeq.prototype;
$c_scm_ArraySeq.prototype.zip__sc_IterableOnce__O = (function(that) {
  return $f_sc_StrictOptimizedIterableOps__zip__sc_IterableOnce__O(this, that)
});
...
$c_scm_ArraySeq.prototype.fromSpecific__sc_IterableOnce__scm_ArraySeq = (function(coll) {
  ...
  var elemRuntimeClass = ((elementClass === $d_V.getClassOf()) ? $d_jl_Void.getClassOf() : (((elementClass === $d_sr_Null$.getClassOf()) || (elementClass === $d_sr_Nothing$.getClassOf())) ? $d_O.getClassOf() : elementClass));
  return $n($x_1).make__O__scm_ArraySeq($n(elemRuntimeClass).jl_Class__f_data.getArrayOf().wrapArray(jsElems))
});
...
$c_scm_ListBuffer.prototype.zip__sc_IterableOnce__O = (function(that) {
  return $f_sc_StrictOptimizedIterableOps__zip__sc_IterableOnce__O(this, that)
});
...
$h_scm_ArrayBuffer.prototype = $c_scm_ArrayBuffer.prototype;
$c_scm_ArrayBuffer.prototype.zip__sc_IterableOnce__O = (function(that) {
  return $f_sc_StrictOptimizedIterableOps__zip__sc_IterableOnce__O(this, that)
});
...
$c_sjs_js_WrappedArray.prototype.zip__sc_IterableOnce__O = (function(that) {
  return $f_sc_StrictOptimizedIterableOps__zip__sc_IterableOnce__O(this, that)
});
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lcom_rockthejvm_Scalar2024__main__AT__V(new ($d_T.getArrayOf().constr)([]));
